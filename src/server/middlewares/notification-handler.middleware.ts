...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  ...
  'menu.create': { roles: ['guest'], key: 'new-menu-item', tenantPath: [], userPath: [] },
  'delivery.update': { roles: ['guest'], key: 'delivery-status-update', tenantPath: [], userPath: [] },
};

const ownerRoles: string[] = ['app-administrator'];
const customerRoles: string[] = ['guest'];
const tenantRoles: string[] = ['restaurant-owner', 'delivery-driver', 'app-administrator'];
