...
export function OrganizationListPage(props: OrganizationListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getOrganizations({
        ...
        order: params.order,
        searchTermKeys: ['description.contains', 'location.contains', 'operation_hours.contains', 'name.contains'],
        ...(params.filters || {}),
      }),
  ...
  const columns: ColumnType[] = [
    ...
    { id: 'operation_hours', header: 'Operation Hours', accessorKey: 'operation_hours' },
